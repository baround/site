...
<main class="post individual">
    <Header />
    <div class="itinerario contenitore" v-if='post'>
    <Meta :post="post" />
        <section class="itinerario__header">
            <figure v-bind:style="{ 'background-image': 'url(' + post.acf.immagine_di_copertina + ')' }">
                <img v-bind:src="post.acf.immagine_di_copertina" />
            </figure>
            <div class="itinerario__header__details">
                <span v-if="post.acf.autore" class="autore">Scritto da {{post.acf.autore}}</span>
                <h1 v-html="post.title.rendered"></h1>
                <span v-if="post.acf.zona" class="zona">{{post.acf.zona}}</span>
            </div>
        </section>
        <section class="itinerario__fascia" v-for="(field, index) in post.acf.contenuto" :key="index">
        ...
        <section class="itinerario__fascia" v-for="(field, index) in post.acf.contenuto" :key="'i_'+index">
...
transition: "slide-right",
    computed: {
        ...
        post() {
            return this.$store.state.content.posts.find(el => el.slug === this.slug);
        },
    },

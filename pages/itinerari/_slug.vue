...
<main class="post individual">
    ...
    <div class="itinerario" v-if='itinerario'>
        ...
        <section class="itinerario__fascia" v-if='correlatiAttivita'>
            <div class="itinerario__fascia__contenuto itinerario__fascia__contenuto--bgBlue itinerario__fascia__contenuto--correlati" :startAttivitaSwiper="startAttivitaSwiper()">
        ...
        <section class="itinerario__fascia" v-if='correlatiLocali'>
            <div class="itinerario__fascia__contenuto itinerario__fascia__contenuto--bgBlue itinerario__fascia__contenuto--correlati" :startLocaliSwiper="startLocaliSwiper()">
...
export default {
    ...
    methods: {
        getPosition: function() {
            return {
                lat: parseFloat(this.itinerario.acf.indirizzo.lat),
                lng: parseFloat(this.itinerario.acf.indirizzo.lng)
            }
        },
    ...
    beforeUpdate(){
        ...
        for (i = 0; i < this.itinerario.acf.locali_vicini.length; i++) {
            ...
            console.log(this.itinerario.acf.locali_vicini[i].ID);
        }
        console.log()
        ...
        var relPosts = [];
        var i;
        for (i = 0; i < this.itinerario.acf.attivita_vicine.length; i++) {
            relPosts.push(this.itinerario.acf.attivita_vicine[i].ID);
        }

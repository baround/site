<template>  
<div v-show="isActive" class="newsletterPage">
  <mailchimp-subscribe
  ...
  >
    <template v-slot="{ subscribe, setEmail, error, success }">
      <div class="newsletterPage__row">
        <div class="newsletterPage__row__col">
          <form class="form" @submit.prevent="subscribe" >
            <div class="form__col">
              <span class="label">Non perderti le nostre novità!</span>
            </div>
            <div class="form__col">

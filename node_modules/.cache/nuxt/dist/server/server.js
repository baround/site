...
/******/ 			var chunk = require("./" + ({"1":"pages/attivita-culturali/_slug","2":"pages/attivita-culturali/index","3":"pages/blog/_slug","4":"pages/index","5":"pages/itinerari/_slug","6":"pages/itinerari/index","7":"pages/locali/_slug","8":"pages/locali/index"}[chunkId]||chunkId) + ".js");
...
const actions = {
  ...
  async locali({
    ...
    try {
      let locali = await fetch(`http://baround.it/be/wp-json/wp/v2/locali?page=1&per_page=100`).then(res => res.json());
  ...
  async attivita({
    ...
    try {
      let attivita = await fetch(`http://baround.it/be/wp-json/wp/v2/attivita_culturali?page=1&per_page=100`).then(res => res.json());
      attivita = attivita.filter(el => el.status === "publish").map(({
        id,
        slug,
        title,
        acf
...
const _a11f097c = () => interopDefault(__webpack_require__.e(/* import() | pages/attivita-culturali/index */ 2).then(__webpack_require__.bind(null, 88)));

const _01f98d71 = () => interopDefault(__webpack_require__.e(/* import() | pages/itinerari/index */ 6).then(__webpack_require__.bind(null, 89)));

const _762ed2be = () => interopDefault(__webpack_require__.e(/* import() | pages/locali/index */ 8).then(__webpack_require__.bind(null, 90)));

const _a48c4c0c = () => interopDefault(__webpack_require__.e(/* import() | pages/attivita-culturali/_slug */ 1).then(__webpack_require__.bind(null, 91)));

const _2fa47afa = () => interopDefault(__webpack_require__.e(/* import() | pages/blog/_slug */ 3).then(__webpack_require__.bind(null, 92)));

const _0042ec29 = () => interopDefault(__webpack_require__.e(/* import() | pages/itinerari/_slug */ 5).then(__webpack_require__.bind(null, 93)));

const _74783176 = () => interopDefault(__webpack_require__.e(/* import() | pages/locali/_slug */ 7).then(__webpack_require__.bind(null, 94)));

const _9b5c6976 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 4).then(__webpack_require__.bind(null, 95))); // TODO: remove in Nuxt 3

...
import nuxt_plugin_plugin_21341eab from 'nuxt_plugin_plugin_21341eab' // Source: ./components/plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"apple-mobile-web-app-capable","content":"yes"},{"name":"apple-mobile-web-app-status-bar-style","content":"white"},{"name":"apple-mobile-web-app-title","content":"Baround"}],"script":[],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"},{"rel":"stylesheet","href":"https:\u002F\u002Ffonts.googleapis.com\u002Fcss2?family=Nunito:wght@200;300;400;600;700&family=Playfair+Display:wght@400;500;600;700&display=swap"}],"style":[]},
  ...
  if (typeof nuxt_plugin_plugin_21341eab === 'function') {
    await nuxt_plugin_plugin_21341eab(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_mailchimp_35b1e47d === 'function') {
    await nuxt_plugin_mailchimp_35b1e47d(app.context, inject)
  }

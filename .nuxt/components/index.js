...
export { default as Itinerariomap } from '../../components/Itinerariomap.vue'
...
export const LazyItinerariomap = import('../../components/Itinerariomap.vue' /* webpackChunkName: "components/Itinerariomap" */).then(c => c.default || c)

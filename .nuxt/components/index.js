...
export { default as NewsletterCassetto } from '../../components/NewsletterCassetto.vue'
...
export const LazyNewsletterCassetto = import('../../components/NewsletterCassetto.vue' /* webpackChunkName: "components/NewsletterCassetto" */).then(c => c.default || c)
export const LazyNewsletterPage = import('../../components/NewsletterPage.vue' /* webpackChunkName: "components/NewsletterPage" */).then(c => c.default || c)
